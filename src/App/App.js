		...
		<React.Fragment>
			...
			<section className="lumx-spacing-padding-horizontal-huge rules">
				...
				<p>
					...
					<br/><a href="https://github.com/lumapps/design-system" target="blank">https://github.com/lumapps/design-system</a>
				</p>
				<p>
				...
				<p>
					For the information that you will be using, you will need to consume Marvel's Open API to retrieve the different characters and their information. You can take a look at the API and how to use it here:<br/>
					<a href="https://developer.marvel.com/docs" target='blank'>https://developer.marvel.com/docs</a>
				</p>
				<p>
					You will need an API key in order to execute these requests. Please use the following one:<br />
